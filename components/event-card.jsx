...
import { Eye, MapPin, QrCode, Trash2, Users, X } from "lucide-react";
...
export default function EventCard({
  ...
  if (variant === "list") {
    return (
      <Card
        className={`py-10 group cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50 ${className}`}
        onClick={onClick}
      >
