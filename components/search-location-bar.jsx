...
export default function SearchLocationBar() {
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="relative flex w-full" ref={searchRef}>
        <div className="flex-1">
          ...
          <Input
            ...
            className="pl-10 w-full h-9 border-gray-700 rounded-none rounded-l-md"
          />
        </div>

        {/* Search Results */}
        {showSearchResults && (
          <div className="absolute top-full mt-2 w-96 bg-background border border-gray-700 rounded-lg shadow-lg z-50 max-h-[400px] overflow-y-auto">
            {searchLoading ? (
      ...
      >
        <SelectTrigger className="w-32 h-9 border-l-0 border-gray-700 rounded-none">
      ...
      >
        <SelectTrigger className="w-32 h-9 rounded-none rounded-r-md border-gray-700 ">
